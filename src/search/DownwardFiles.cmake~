...
set(CORE_SOURCES
	...
	plan_exploiting_search.cc
	plan_extractable_heuristic.cc
	plan_not_extractable_exception.cc
	plateau_statistics.cc
        plugin.cc
        priority_queue.cc
        restart_strategy.cc
        rng.cc
...
fast_downward_plugin(
    NAME CONST_EVALUATOR_M
    HELP "The constant evaluator2.0"
    SOURCES
        const_evaluator_mark.cc
)
...
fast_downward_plugin(
    NAME EAGER_SEARCH_COMPARE
    HELP "Eager search algorithm with comparing heuristics"
    SOURCES
        eager_search_comparing.cc
...
fast_downward_plugin(
    NAME EHC_SEARCH_DD
    HELP "EHC search algorithm w/o Duplicate Detection in BFS"
    SOURCES
        ehc_duplicate_detection.cc
    DEPENDS G_EVALUATOR
)

fast_downward_plugin(
    NAME EHC_SEARCH_MARK
    HELP "EHC search algorithm for plateau investigation"
    SOURCES
        ehc_mark.cc
    DEPENDS G_EVALUATOR
)
...
fast_downward_plugin(
    NAME EHC_SEARCH_RW
    HELP "EHC search algorithm with RWs instead of BFS"
    SOURCES
        ehc_rw.cc
    DEPENDS G_EVALUATOR
)
...
fast_downward_plugin(
    NAME EHC_SEARCH_RW_FIED_PROBABILITY
    HELP "EHC search algorithm with fixed prob RWs instead of BFS"
    SOURCES
        ehc_rw_fixed_probability.cc
    DEPENDS G_EVALUATOR
)
...
fast_downward_plugin(
    ...
    HELP "The Novelty metric evaluator"
    SOURCES novelty_heuristic.cc
)
...
#fast_downward_plugin(
#    NAME DELETE_RELAXATION
#    HELP "Plugin containing the code for delete relaxation heuristics"
#    SOURCES
#	delete_relaxation/delete_relaxation_heuristic.cc
#	delete_relaxation/delete_relaxation_variables.cc
#	delete_relaxation/constraints/delete_relaxation_constraints_generator.cc
#	delete_relaxation/constraints/delete_relaxation_constraints_original.cc
#	delete_relaxation/constraints/delete_relaxation_constraints_original2.cc
#	delete_relaxation/constraints/delete_relaxation_constraints_time.cc
#	delete_relaxation/constraints/delete_relaxation_constraints_time_original.cc
#	delete_relaxation/constraints/delete_relaxation_constraints_circular_independence.cc
#	delete_relaxation/constraints/delete_relaxation_constraints_to_achieve.cc
#	delete_relaxation/objectives/delete_relaxation_objective.cc
#	delete_relaxation/objectives/delete_relaxation_min_plan_cost.cc
#	delete_relaxation/delete_relaxation_model.cc
#
#    DEPENDS LP_SOLVER
#)
...
fast_downward_plugin(
    NAME LUBYRESTARTSTRATEGY
    HELP "luby restarts"
    SOURCES luby_restart_strategy.cc
    DEPENDS restart_strategy.cc
)

fast_downward_plugin(
    NAME EXPRESTARTSTRATEGY
    HELP "exp restarts"
    SOURCES exponential_restart_strategy.cc
    DEPENDS restart_strategy.cc
)
