...
//EvaluationContext::EvaluationContext(const EvaluationContext& other)
//    : EvaluationContext(other.cache, other.g_value, other.is_preferred, other.statistics, other.calculate_preferred) {
//}

const EvaluationResult &EvaluationContext::get_result(ScalarEvaluator *heur) {
    EvaluationResult &result = cache[heur];
    if (result.is_uninitialized()) {
    	//cout << "computing heuristic for first time " << endl;
