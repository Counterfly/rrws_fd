...
//    EvaluationContext(const EvaluationContext&);
    ...
    // This did not work with the original 'const SS& get_statistics() const method
    //SearchStatistics* get_statistics_non_const();
