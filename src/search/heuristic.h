...
override	;
	...
	virtual void initialize_public() {
		initialize();
	}
	...
	/**
	 * Call once a search generates a state for the first time.
	 */
...
//            const State &state) {return false;}
	...
	virtual double compute_heuristic_double(const GlobalState &state) {
