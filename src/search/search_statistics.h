...
public:
	typedef std::vector<const GlobalOperator *> Plan;	// Taken From SearchEngine
...
public:
    ...
    void set_found_solution(bool found) { found_solution = found; }
    void set_plan(Plan plan) { found_solution = true; this->plan = plan; };
    ...
    bool get_found_solution() const { return found_solution; }
    Plan get_plan() const { return plan; }
    /*
